...
<div class="students view content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group" role="group">
            ...
            <a href="/students/add" class="btn btn-success">New Student</a>
            <a href="/studies/add" class="btn btn-warning">Add Study</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
                            ...
                            <?php if (!empty($student['studies'])): ?>
                                ...
                                <p><strong>Total P&L:</strong> 
                                    <span class="<?= $totalProfitLoss >= 0 ? 'text-success' : 'text-danger' ?>">
                                        <?= CurrencyHelper::formatForUser($totalProfitLoss, $student['currency'] ?? 'BRL') ?>
                                    </span>
                                </p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="<?= $study['profit_loss'] >= 0 ? 'text-success' : 'text-danger' ?>">
                                            <?= CurrencyHelper::formatForUser($study['profit_loss'], $student['currency'] ?? 'BRL') ?>
                                        </span>
                                    </td>
                                    <td class="actions">
                                        <a href="/studies/view/<?= $study['id'] ?>" class="btn btn-sm btn-outline-primary" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/studies/edit/<?= $study['id'] ?>" class="btn btn-sm btn-outline-secondary" title="Edit">
                    ...
                    <div class="text-center mt-3">
                        <a href="/studies/byStudent/<?= $student['id'] ?>" class="btn btn-primary">View All Studies</a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="alert alert-info">
                ...
                <a href="/studies/add" class="alert-link">Add the first study</a> to get started!</p>
            </div>
            <?php endif; ?>
        </div>
    </div>
