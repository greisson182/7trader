<?php
require_once ROOT . DS . 'src' . DS . 'Helper' . DS . 'DateHelper.php';
                        ...
                        <?php foreach ($topStudents as $index => $student): ?>
                            <div class="d-flex align-items-center mb-3 <?= $index < count($topStudents) - 1 ? 'border-bottom pb-3' : '' ?>">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1">
                                        <a href="/students/view/<?= $student['id'] ?>" class="text-decoration-none">
                                            <?= h($student['name']) ?>
                                        </a>
                                    </h6>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($recentActivity as $activity): ?>
                                        <tr>
                                            <td>
                                                <a href="/students/view/<?= $activity['student_id'] ?>" class="text-decoration-none">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlyLabels = [
        <?php foreach ($monthlyData as $data): ?>
            '<?= DateHelper::formatMonthYear($data['month'], $data['year'], true) ?>',
        <?php endforeach; ?>
    ];
