 ...
 * @var array $dailyMetrics
 * @var array $monthlyMetrics
 * @var array $recentStudies
        ...
        <div class="col-md-3">
            <div class="card <?= $overallStats['total_profit_loss'] >= 0 ? 'bg-success' : 'bg-danger' ?> text-white">
                <div class="card-body text-center">
                    ...
                    <h2><?= CurrencyHelper::formatForUser($overallStats['total_profit_loss'], $student->currency ?? 'BRL') ?></h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                ...
                                <h4 class="<?= $dailyMetrics['total_profit_loss'] >= 0 ? 'text-success' : 'text-danger' ?>">
                                    <?= CurrencyHelper::formatForUser($dailyMetrics['total_profit_loss'], $student->currency ?? 'BRL') ?>
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                ...
                                <h4 class="<?= $monthlyMetrics['total_profit_loss'] >= 0 ? 'text-success' : 'text-danger' ?>">
                                    <?= CurrencyHelper::formatForUser($monthlyMetrics['total_profit_loss'], $student->currency ?? 'BRL') ?>
                                </h4>
                            </div>
                        </div>
                    </div>
