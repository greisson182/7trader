...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <a href="/studies/edit/<?= h($study['id']) ?>" class="btn btn-primary mb-2 btn-with-icon">
                <i class="fas fa-edit"></i>
                <span>Editar Estudo</span>
            </a>
            <form method="post" action="/studies/delete/<?= h($study['id']) ?>" style="display: inline;" onsubmit="return confirm('Tem certeza que deseja excluir este estudo?');">
                <button type="submit" class="btn btn-danger mb-2 btn-with-icon">
                    <i class="fas fa-trash"></i>
                    <span>Excluir Estudo</span>
                </button>
            </form>
            <a href="/studies" class="btn btn-secondary mb-2 btn-with-icon">
                <i class="fas fa-list"></i>
                <span>Listar Estudos</span>
            </a>
            <a href="/studies/add" class="btn btn-success mb-2 btn-with-icon">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                ...
                                <?php if ($study['profit_loss'] > 0): ?>
                                    <p class="mb-0">Lucro/prejuízo positivo de <?= CurrencyHelper::formatForUser($study['profit_loss'], $study['user']['currency'] ?? 'BRL') ?> demonstra gestão de risco eficaz.</p>
                                <?php else: ?>
