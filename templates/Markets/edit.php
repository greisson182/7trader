...
<div class="markets form content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="/markets/view/<?= $market['id'] ?>" class="btn btn-outline-primary btn-with-icon me-2">
                <i class="bi bi-eye"></i>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="/markets/edit/<?= $market['id'] ?>" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="/markets" class="btn btn-secondary me-md-2 btn-with-icon">
