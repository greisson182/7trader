...
<div class="markets index content fade-in-up">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        ...
        <?php if (isset($currentUser) && $currentUser['role'] === 'admin'): ?>
            <a href="/markets/add" class="btn btn-primary btn-lg">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="market-actions">
                                <div class="d-grid gap-2">
                                    <a href="/markets/view/<?= $market['id'] ?>" class="btn btn-primary">
                                    ...
                                    <?php if (isset($currentUser) && $currentUser['role'] === 'admin'): ?>
                                        <div class="btn-group" role="group">
                                            <a href="/markets/edit/<?= $market['id'] ?>" class="btn btn-outline-warning btn-sm">
                                                <i class="bi bi-pencil me-1"></i>
                                                Editar
                                            </a>
                                            <a href="/markets/delete/<?= $market['id'] ?>" 
                                               class="btn btn-outline-danger btn-sm" 
                                               onclick="return confirm('Tem certeza que deseja excluir este mercado?')">
    ...
    <?php else: ?>
        ...
        <div class="text-center py-5">
            <div class="empty-state">
                ...
                <?php if (isset($currentUser) && $currentUser['role'] === 'admin'): ?>
                    <a href="/markets/add" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-2"></i>
