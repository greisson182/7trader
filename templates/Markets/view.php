    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group" role="group">
            <?php if (isset($_SESSION['user']['role']) && $_SESSION['user']['role'] === 'admin'): ?>
                <a href="/markets/edit/<?= $market['id'] ?>" class="btn btn-primary btn-with-icon">
                    <i class="bi bi-pencil-square"></i>
                    <span>Editar</span>
                </a>
            <?php endif; ?>
            <a href="/markets" class="btn btn-secondary btn-with-icon">
                <i class="bi bi-list"></i>
                <span>Listar Mercados</span>
            </a>
            <?php if (isset($_SESSION['user']['role']) && $_SESSION['user']['role'] === 'admin'): ?>
                <a href="/markets/add" class="btn btn-success btn-with-icon">
                    ...
                    <tbody>
                        <?php foreach (array_slice($studies, 0, 10) as $study): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/students/view/<?= $study['student_id'] ?>" class="text-decoration-none">
                                ...
                                <td>
                                    <a href="/studies/view/<?= $study['id'] ?>" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
